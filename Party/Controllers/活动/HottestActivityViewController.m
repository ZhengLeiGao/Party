//
//  HottestActivityViewController.m
//  Party
//
...
@interface HottestActivityViewController () <UITableViewDataSource,UITableViewDelegate>
...
@implementation HottestActivityViewController
...
- (void)loadData {
    ...
    NSDictionary *dict = @{@"act":@"allactivity",@"sort_id":@(2),@"uid":@"0",@"page":@(1),@"city_id":@"110100",@"longitude":@(113.682316),@"latitude":@(34.778620),@"mod":@"Activity",@"count":@(20)};
    
    
    __weak typeof(self) weakSelf = self;
    [self.manager POST:ActivityHotURL parameters:dict success:^(AFHTTPRequestOperation *operation, id responseObject) {
