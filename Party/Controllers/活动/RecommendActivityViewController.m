...
@interface RecommendActivityViewController () <UITableViewDataSource,UITableViewDelegate>
...
- (void)loadData {
    ...
    NSDictionary *dict = @{@"act":@"allactivity",@"uid":@"0",@"is_recommend":@(1),@"page":@(1),@"city_id":@"110100",@"longitude":@(113.682316),@"latitude":@(34.778620),@"mod":@"Activity",@"count":@(20)};
    
    
    __weak typeof(self) weakSelf = self;
    [self.manager POST:ActivityRecommendURL parameters:dict success:^(AFHTTPRequestOperation *operation, id responseObject) {
