...
@interface FreeActivityViewController () <UITableViewDataSource,UITableViewDelegate>
...
@implementation FreeActivityViewController
...
- (void)loadData {
    ...
    NSDictionary *dict = @{@"act":@"allactivity",@"uid":@"0",@"page":@(1),@"city_id":@"110100",@"longitude":@(113.682316),@"latitude":@(34.778620),@"mod":@"Activity",@"is_free":@(1),@"count":@(20)};
    
    
    __weak typeof(self) weakSelf = self;
    [self.manager POST:ActivityFreeURL parameters:dict success:^(AFHTTPRequestOperation *operation, id responseObject) {
